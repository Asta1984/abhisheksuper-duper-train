          ...
          <div>
            <p className="text-white-400 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
              <Image
                ...
                width={100}
                height={100}
              /> Master's at Polimi Graduate School of Management, Italy
            </p>
          ...
          <div>
            <p className="text-white-400 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
              <Image
                ...
                width={100}
                height={50}
              />Product Manager at SNA SISTEC PVT LTD.
            </p>
            <div className="grid grid-cols-2 gap-4">
              <ImageZoom
        ...
        content: (
          <div>
            ...
            <Image
                ...
                height={50}
              />
              Bachelors' of Technology, UITRGPV, India
            </p>
            <div className="grid grid-cols-2 gap-4">
              <ImageZoom
